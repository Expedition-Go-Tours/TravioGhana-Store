        ...
        <div className="footer-bottom">
          <div className="footer-bottom-left">
            ...
            <div className="footer-socials">
              <a href="https://www.instagram.com/travioGhanatourstours" target="_blank" rel="noopener noreferrer" className="footer-social footer-social--instagram" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@expeditiongotours" target="_blank" rel="noopener noreferrer" className="footer-social footer-social--tiktok" aria-label="TikTok">
              ...
              <a href="https://www.youtube.com/c/ExpeditionGoTravelandToursLTD" target="_blank" rel="noopener noreferrer" className="footer-social footer-social--youtube" aria-label="YouTube">
